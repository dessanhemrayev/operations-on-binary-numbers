...
void __fastcall TForm1::Button1Click(TObject *Sender)
{
 try
 {
   ...
   else if (RadioButton3->Checked)
   {
	...
	if (i==0)
	{
		 Label47->Caption+=" "+IntToStr(a1[i]);
		 Label47->Caption+= " . ";
		 Label48->Caption+= " "+IntToStr(b1[i]);
		  Label48->Caption+= " . ";
		  Label53->Caption+=" "+IntToStr(a1[i]);
		 Label53->Caption+= " . ";
		 Label54->Caption+= " "+IntToStr(b1[i]);
		 Label54->Caption+= " . ";
	}
	else{
		 Label47->Caption+= IntToStr(a1[i]);
    ...
    for (size_t i = 0; i < 17; i++)
		...
		if (i==0)
		{
		Label55->Caption+= " "+IntToStr(c1[i]);
		Label55->Caption+= " . ";
		Label56->Caption+= " "+IntToStr(c1[i]);
		Label56->Caption+= " . ";
		}
         else{
		 Label55->Caption+= IntToStr(c1[i]);
	   ...
	   Label44->Caption+= IntToStr(twoToten(c1));
		//print_d(a2, b2, c1);
    }
    else
	{
